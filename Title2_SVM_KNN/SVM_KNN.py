...
main = tkinter.Tk()
main.title("Classification of Lung Cancer Nodules to Monitor Patients Health using Neural Network topology with SVM algorithm & Compare with K-Nearest Neighbors Accuracy")
main.geometry("2000x1200")
...
font = ('times', 14, 'bold')
title = Label(main, text='Classification of Lung Cancer Nodules to Monitor Patients Health using Neural Network topology with SVM algorithm & Compare with K-Nearest Neighbors Accuracy')
